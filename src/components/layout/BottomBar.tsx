      ...
      <Block display="flex" alignItems="center" gridGap="scale200">
        ...
        <Block display="flex" alignItems="center" gridGap="scale0">
          ...
          <Button
            kind={KIND.tertiary}
            size={SIZE.mini}
            onClick={() => openLink('https://www.linkedin.com/in/rajavelas/')}
            aria-label="LinkedIn"
            overrides={{
              BaseButton: {
                style: {
          ...
          <Button
            kind={KIND.tertiary}
            size={SIZE.mini}
            onClick={() => openLink('https://github.com/asrajavel/portfolio-simulator')}
            aria-label="GitHub"
            overrides={{
              BaseButton: {
                style: {
          ...
          <Button
            kind={KIND.tertiary}
            size={SIZE.mini}
            onClick={() => openLink('https://www.buymeacoffee.com/rajavel')}
